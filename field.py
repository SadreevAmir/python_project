...
def create_vertical_borders(num_field):
        for i in range(NUMBER_OF_VERTICAL_BLOCKS):
            num_field[i][0], num_field[i][NUMBER_OF_HORIZONTAL_BLOCKS-1] = -2, -2


def create_horizontal_borders(num_field):
        num_field[0] = [-2] * NUMBER_OF_HORIZONTAL_BLOCKS
        num_field[NUMBER_OF_VERTICAL_BLOCKS-1] = [-2] * NUMBER_OF_HORIZONTAL_BLOCKS
